...
@section('title', 'Purchase Request Approval')
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-header pb-0 bg-light text-white">
                            <h4 class="mb-0 text-center">Purchase Request Approval</h4>
                        </div>

                        {{-- Card Body --}}
                        <div class="card-body px-4 pt-4 pb-4">
                            <form action="{{ route('pr.approve.update', $pr) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" id="verifySwitch"
                                                {{ old('approval_status', $pr->approved_status) === 'APPROVED' ? 'checked' : '' }}>

                                            <input type="hidden" name="approval_status" id="approvalStatus"
                                                   value="{{ old('approved_status', $pr->approved_status) ?? 'PENDING' }}">

                                            <span id="verifyBadge" class="badge {{ $pr->approved_status === 'APPROVED' ? 'bg-success' : 'bg-warning' }}">
                                                {{ old('approved_status', $pr->approved_status) ?? 'PENDING' }}
                                            </span>
                                        </div>
                                    </div>
