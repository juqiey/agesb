...
@section('title', 'Purchase Request Confirmation')
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-header pb-0 bg-light text-white">
                            <h4 class="mb-0 text-center">Purchase Request Confirm</h4>
                        </div>

                        {{-- Card Body --}}
                        <div class="card-body px-4 pt-4 pb-4">
                            <form action="{{ route('pr.confirm.update', $pr) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4 p-3 border rounded bg-white">
                                    <h6 class="mb-3 text-uppercase fw-bold text-primary">Confirmation</h6>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" id="verifySwitch"
                                                {{ old('confirmation_status', $pr->confirmed_status) === 'CONFIRMED' ? 'checked' : '' }}>

                                            <input type="hidden" name="confirmation_status" id="confirmationStatus"
                                                   value="{{ old('confirmed_status', $pr->confirmed_status) ?? 'PENDING' }}">

                                            <span id="verifyBadge" class="badge {{ $pr->confirmed_status === 'CONFIRMED' ? 'bg-success' : 'bg-warning' }}">
                                                {{ old('confirmed_status', $pr->confirmed_status) ?? 'PENDING' }}
                                            </span>
                                        </div>
                                    </div>
